      ...
      <div className="fixed bottom-20 right-4 sm:bottom-6 sm:right-6 z-[60]">
        <Sheet open={isOpen} onOpenChange={setIsOpen}>
          ...
          >
            ...
            {/* Clean Chat Messages - Larger space for mobile */}
            <div className="flex-1 overflow-y-auto p-4 sm:p-4 space-y-4 min-h-0 bg-gray-50/50" style={{ minHeight: 'calc(70vh - 200px)' }}>
            ...
            {/* Clean Quick Actions - Compact for mobile to give more chat space */}
            <div className="p-2 sm:p-4 border-t border-gray-100 bg-white">
              <div className="space-y-1.5 sm:space-y-3">
                <div className="flex items-center gap-1.5 sm:gap-2 mb-1.5 sm:mb-3">
                  <div className="w-4 h-4 sm:w-6 sm:h-6 bg-gray-800 rounded-full flex items-center justify-center">
                    <Sparkles className="h-2 w-2 sm:h-3 sm:w-3 text-white" />
                  </div>
                  <p className="text-[10px] sm:text-sm font-semibold text-gray-900">Quick Help</p>
                </div>
                <div className="grid grid-cols-2 gap-1 sm:gap-2">
                  {quickQuestions.map((question, index) => (
                    <button
                      ...
                      className="text-left p-1.5 sm:p-3 bg-gray-50 hover:bg-gray-100 border border-gray-200 hover:border-gray-800 rounded-lg sm:rounded-xl transition-all duration-200 group disabled:opacity-50 hover:scale-105 active:scale-95"
                      disabled={isLoading}
                    >
                      <div className="flex items-center gap-1 sm:gap-2">
                        <div className="w-1 h-1 sm:w-1.5 sm:h-1.5 bg-gray-800 rounded-full group-hover:bg-gray-900 group-hover:scale-125 transition-all duration-200"></div>
                        <span className="text-[9px] sm:text-xs font-medium text-gray-700 group-hover:text-gray-900 truncate">{question}</span>
                        <Sparkles className="h-2 w-2 sm:h-3 sm:w-3 text-gray-800 opacity-0 group-hover:opacity-100 transition-opacity duration-200 flex-shrink-0" />
                      </div>
                    </button>
                  ))}
                </div>
            ...
            {/* Clean Input Area - Very compact for mobile to maximize chat space */}
            <div className="p-2 sm:p-4 border-t border-gray-100 bg-white">
              <div className="flex gap-1.5 sm:gap-3">
                <div className="flex-1 relative">
                  <input
                    ...
                    className="w-full px-2.5 sm:px-4 py-1.5 sm:py-3 pr-8 sm:pr-12 text-xs sm:text-sm border border-gray-200 rounded-lg sm:rounded-2xl focus:border-gray-800 focus:ring-2 focus:ring-gray-200 transition-all duration-200 bg-gray-50 focus:bg-white"
                    disabled={isLoading}
                  />
                  {inputText.trim() && (
                    <div className="absolute right-2.5 sm:right-4 top-1/2 transform -translate-y-1/2">
                ...
                <button
                  ...
                  className="px-2.5 sm:px-4 py-1.5 sm:py-3 bg-gray-800 hover:bg-gray-900 disabled:bg-gray-300 text-white rounded-lg sm:rounded-2xl transition-all duration-200 disabled:cursor-not-allowed flex items-center justify-center min-w-[40px] sm:min-w-[48px]"
                >
                  {isLoading ? (
              ...
              <div className="flex items-center justify-between mt-1 sm:mt-2 text-[9px] sm:text-xs text-gray-400">
