                ...
                <div className="grid grid-cols-2 gap-2">
                  {quickQuestions.map((question, index) => (
                    <button
                      ...
                      className="text-left p-3 bg-gray-50 hover:bg-gray-100 border border-gray-200 hover:border-gray-800 rounded-lg transition-all duration-200 group disabled:opacity-50 hover:scale-105 active:scale-95"
                      disabled={isLoading}
                    >
                      <div className="flex items-center gap-2">
                        ...
                        <Sparkles className="h-3 w-3 text-gray-800 opacity-0 group-hover:opacity-100 transition-opacity duration-200" />
                      </div>
                    </button>
                  ))}
                </div>
