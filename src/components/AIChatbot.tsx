    ...
    <>
      ...
      <div className="fixed bottom-20 right-4 sm:bottom-6 sm:right-6 z-[60]">
        <Sheet open={isOpen} onOpenChange={setIsOpen}>
          ...
          <SheetContent 
            side="right" 
            className="w-[86vw] max-w-[380px] sm:w-[480px] h-[85vh] sm:h-[90vh] p-0 bg-white border-l border-gray-200 flex flex-col [&>button]:hidden"
          >
            ...
            <div className="flex-1 overflow-y-auto p-4 sm:p-4 space-y-4 min-h-0 bg-gray-50/50" style={{ minHeight: 'calc(85vh - 280px)' }}>
            ...
            {/* Clean Quick Actions - Positioned lower for better chat space */}
            <div className="p-3 sm:p-4 border-t border-gray-100 bg-white mt-auto">
                ...
                <div className="grid grid-cols-2 gap-1.5 sm:gap-2">
                  {quickQuestions.map((question, index) => (
                    <button
                      ...
                      className="text-left p-2 sm:p-3 bg-gray-50 hover:bg-gray-100 border border-gray-200 hover:border-gray-800 rounded-lg sm:rounded-xl transition-all duration-200 group disabled:opacity-50 hover:scale-105 active:scale-95"
                      disabled={isLoading}
                    >
                      <div className="flex items-center gap-1.5 sm:gap-2">
                        ...
                        <span className="text-[10px] sm:text-xs font-medium text-gray-700 group-hover:text-gray-900 truncate">{question}</span>
            ...
            {/* Clean Input Area - Compact for mobile */}
              ...
              <div className="flex gap-2 sm:gap-3">
                <div className="flex-1 relative">
                  <input
                    ...
                    className="w-full px-3 sm:px-4 py-2 sm:py-3 pr-10 sm:pr-12 text-xs sm:text-sm border border-gray-200 rounded-xl sm:rounded-2xl focus:border-gray-800 focus:ring-2 focus:ring-gray-200 transition-all duration-200 bg-gray-50 focus:bg-white"
                    disabled={isLoading}
                  />
                  {inputText.trim() && (
                ...
                <button
                  ...
                  className="px-3 sm:px-4 py-2 sm:py-3 bg-gray-800 hover:bg-gray-900 disabled:bg-gray-300 text-white rounded-xl sm:rounded-2xl transition-all duration-200 disabled:cursor-not-allowed flex items-center justify-center min-w-[44px] sm:min-w-[48px]"
                >
                  {isLoading ? (
