        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4">
          ...
          <CardContent>
            ...
            <Link to="/sell/new" className="block">
                <Button size="sm" className="w-full h-[50px] !text-[15px] !font-black !bg-black hover:!bg-gray-900 !text-white !rounded-2xl !border-[1.5px] !border-black relative overflow-hidden group transition-all !duration-150 active:!translate-y-[4px] active:!shadow-[0_1px_0_0_rgba(0,0,0,0.85)] !shadow-[0_5px_0_0_rgba(0,0,0,0.85)]">
          ...
          <CardContent>
            ...
            <Link to="/sell/marketplace" className="block">
                <Button variant="outline" size="sm" className="w-full h-[50px] !text-[15px] !font-black !bg-white hover:!bg-gray-50 !text-black !rounded-2xl !border-[1.5px] !border-black relative overflow-hidden group transition-all !duration-150 active:!translate-y-[4px] active:!shadow-[0_1px_0_0_rgba(0,0,0,0.85)] !shadow-[0_5px_0_0_rgba(0,0,0,0.85)]">
                  <div className="absolute inset-0 bg-gradient-to-b from-white/10 to-transparent rounded-2xl pointer-events-none" />
