          ...
          <CardHeader className="bg-gradient-to-r from-green-600 to-emerald-600 text-white">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-green-100 mt-2">Last Updated: {new Date().toLocaleDateString('en-IN', { day: 'numeric', month: 'long', year: 'numeric' })}</p>
              </div>
            </div>
          </CardHeader>
            ...
            <ScrollArea className="h-[70vh] pr-4">
              <div className="space-y-6 text-gray-700">
                ...
                <section>
                  ...
                  <p className="mb-3">
                    At Enqir.in, we strive to provide the best experience for our users. This Refund and Cancellation Policy outlines the circumstances under which refunds are provided for our AI-powered marketplace services.
                  </p>
                  <p className="bg-blue-50 p-4 rounded-lg border-l-4 border-blue-500">
                    <strong>Important:</strong> All payments are processed securely through Razorpay Payment Gateway. Once a payment plan is activated and responses are unlocked, the service is considered delivered.
                  </p>
                </section>
                ...
                <section>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="bg-green-50 p-4 rounded-lg border-l-4 border-green-500">
                      <h3 className="text-lg font-semibold text-gray-800 mb-2">✅ Service Not Delivered</h3>
                      <ul className="list-disc pl-6 space-y-2">
                        <li>Payment confirmed but no upgrade/unlocking occurred</li>
                        <li>Plan activation failed despite successful payment</li>
                        <li>Pro Plan purchased but auto-premium feature not working</li>
                      </ul>
                      <p className="mt-2 text-sm text-gray-600">
                        <strong>Refund:</strong> Full refund after verification.
                      </p>
                    </div>
                ...
                <section>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-500">
                      <h3 className="text-lg font-semibold text-gray-800 mb-2">❌ Pro Plan After Usage</h3>
                      <ul className="list-disc pl-6 space-y-2">
                        <li>Refund request for Pro Plan after using any of the 10 premium enquiries</li>
                        <li>Partial refund for unused Pro enquiries</li>
                      </ul>
                      <p className="mt-2 text-sm text-red-700 font-semibold">
                        Pro Plan is a prepaid package. Once activated, it cannot be refunded or partially refunded.
                      </p>
                    </div>
                  ...
                  <div className="bg-blue-50 p-4 rounded-lg space-y-3">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600">Email <a href="mailto:refunds@enqir.in" className="text-blue-600 hover:underline font-semibold">refunds@enqir.in</a> with subject "Refund Request - [Transaction ID]"</p>
                      </div>
                    </div>
                ...
                <section>
                  <h2 className="text-2xl font-semibold text-gray-900 mb-3">5. Refund Timeline</h2>
                  <div className="bg-gray-50 p-4 rounded-lg">
                    <ul className="space-y-2">
                      ...
                      <li className="flex items-start gap-2">
                        <CheckCircle className="w-5 h-5 text-green-600 flex-shrink-0 mt-0.5" />
                        <span><strong>Refund Initiation:</strong> 5-7 business days after approval</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <CheckCircle className="w-5 h-5 text-green-600 flex-shrink-0 mt-0.5" />
                    ...
                    <p className="mt-4 text-sm text-gray-600">
                      <strong>Total Maximum Time:</strong> Up to 20 business days from request to bank credit.
                    </p>
                  </div>
                </section>
                ...
                <section>
                  ...
                  <div className="bg-yellow-50 p-4 rounded-lg border-l-4 border-yellow-500">
                    ...
                    <ul className="list-disc pl-6 space-y-2">
                      ...
                      <li>Pro Plan activation is immediate and cannot be cancelled once purchased</li>
                    </ul>
                  </div>
                </section>

                <section>
                  <h2 className="text-2xl font-semibold text-gray-900 mb-3">7. Payment Plan-Specific Terms</h2>
                  
                  <div className="space-y-3">
                    <div className="border-l-4 border-purple-500 pl-4">
                      <h3 className="font-semibold text-gray-800">Free Plan (₹0)</h3>
                      <p className="text-sm text-gray-600">No payment, no refund applicable</p>
                    </div>

                    <div className="border-l-4 border-blue-500 pl-4">
                      <h3 className="font-semibold text-gray-800">Basic Plan (₹99)</h3>
                      <p className="text-sm text-gray-600">Unlocks 5 responses for one enquiry. No refund after viewing responses.</p>
                    </div>

                    <div className="border-l-4 border-green-500 pl-4">
                      <h3 className="font-semibold text-gray-800">Standard Plan (₹199)</h3>
                      <p className="text-sm text-gray-600">Unlocks 10 responses for one enquiry. No refund after viewing responses.</p>
                    </div>

                    <div className="border-l-4 border-yellow-500 pl-4">
                      <h3 className="font-semibold text-gray-800">Premium Plan (₹499)</h3>
                      <p className="text-sm text-gray-600">Unlocks unlimited responses for one enquiry. No refund after activation.</p>
                    </div>

                    <div className="border-l-4 border-indigo-500 pl-4">
                      <h3 className="font-semibold text-gray-800">Pro Plan (₹1,499)</h3>
                      <p className="text-sm text-gray-600">Next 10 enquiries get auto-premium. No refund after using any enquiry. No partial refunds.</p>
                    </div>
                  </div>
                </section>
                ...
                <section>
                  ...
                  <ul className="list-disc pl-6 space-y-2">
                    <li>You may escalate to our senior support team at <a href="mailto:disputes@enqir.in" className="text-blue-600 hover:underline">disputes@enqir.in</a></li>
                    ...
                    <li>If still unresolved, you may pursue legal recourse as per our Terms and Conditions</li>
                  </ul>
                </section>
                ...
                <section>
                  ...
                  <div className="bg-gray-50 p-4 rounded-lg">
                    <p className="mb-3"><strong>For Refund Requests:</strong></p>
                    <p className="mb-2"><strong>Email:</strong> <a href="mailto:refunds@enqir.in" className="text-blue-600 hover:underline">refunds@enqir.in</a></p>
                    ...
                    <p className="mb-4"><strong>Response Time:</strong> Within 24-48 hours</p>
                    
                    <p className="mb-3"><strong>Required Information in Email:</strong></p>
                ...
                <section>
                  ...
                  <p>
                    We reserve the right to modify this Refund and Cancellation Policy at any time. Changes will be effective immediately upon posting. Continued use of the Platform after changes constitutes acceptance.
                  </p>
                </section>

                <section className="border-t pt-6 mt-6 bg-blue-50 p-4 rounded-lg">
