        ...
        <Card className="shadow-2xl border-0 overflow-hidden">
          <CardHeader className="bg-gray-800 text-gray-900 p-3 sm:p-4 md:p-6">
            <div className="flex items-center gap-2 sm:gap-3">
              <RefreshCw className="w-5 h-5 sm:w-6 sm:h-6 md:w-8 md:h-8" />
              <div>
                <CardTitle className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-bold">Refund & Cancellation Policy</CardTitle>
