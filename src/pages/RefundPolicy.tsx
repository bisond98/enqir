    ...
    <Layout>
      <div className="container mx-auto px-2 sm:px-4 py-4 sm:py-8 max-w-4xl">
        <Card className="shadow-lg bg-gray-800 border-gray-700">
          <CardHeader className="bg-gradient-to-r from-green-600 to-emerald-600 text-white p-4 sm:p-6 border-b border-gray-700">
          ...
          <CardContent className="p-4 sm:p-6 bg-gray-800">
            <ScrollArea className="h-[calc(100vh-8rem)] sm:h-[70vh] pr-2 sm:pr-4">
              <div className="space-y-4 sm:space-y-6 text-gray-200 text-sm sm:text-base">
                ...
                <section>
                  <h2 className="text-xl sm:text-2xl font-semibold text-white mb-2 sm:mb-3">1. Overview</h2>
                  ...
                  <p className="bg-gray-700 p-3 sm:p-4 rounded-lg border-l-4 border-blue-500 leading-relaxed">
                ...
                <section>
                  ...
                  <div className="space-y-4">
                    <div className="bg-gray-700 p-4 rounded-lg border-l-4 border-green-500">
                      <h3 className="text-lg font-semibold text-gray-100 mb-2">✅ Technical Payment Errors</h3>
                    ...
                    <div className="bg-gray-700 p-4 rounded-lg border-l-4 border-green-500">
                      <h3 className="text-lg font-semibold text-gray-100 mb-2">✅ Duplicate/Accidental Payments</h3>
                      <ul className="list-disc pl-6 space-y-2">
                    ...
                    <div className="bg-gray-700 p-3 sm:p-4 rounded-lg border-l-4 border-green-500">
                      <h3 className="text-base sm:text-lg font-semibold text-gray-100 mb-1.5 sm:mb-2">✅ Service Not Delivered</h3>
                    ...
                    <div className="bg-gray-700 p-4 rounded-lg border-l-4 border-green-500">
                      <h3 className="text-lg font-semibold text-gray-100 mb-2">✅ Unauthorized Transactions</h3>
                      <ul className="list-disc pl-6 space-y-2">
                ...
                <section>
                  ...
                  <div className="space-y-4">
                    <div className="bg-gray-700 p-4 rounded-lg border-l-4 border-red-500">
                      <h3 className="text-lg font-semibold text-gray-100 mb-2">❌ Change of Mind</h3>
                      <ul className="list-disc pl-6 space-y-2">
                    ...
                    <div className="bg-gray-700 p-4 rounded-lg border-l-4 border-red-500">
                      <h3 className="text-lg font-semibold text-gray-100 mb-2">❌ Dissatisfaction with Seller Responses</h3>
                      <ul className="list-disc pl-6 space-y-2">
                    ...
                    <div className="bg-gray-700 p-4 rounded-lg border-l-4 border-red-500">
                      <h3 className="text-lg font-semibold text-gray-100 mb-2">❌ No Seller Responses Received</h3>
                      <ul className="list-disc pl-6 space-y-2">
                    ...
                    <div className="bg-gray-700 p-4 rounded-lg border-l-4 border-red-500">
                      <h3 className="text-lg font-semibold text-gray-100 mb-2">❌ Terms of Service Violation</h3>
                      <ul className="list-disc pl-6 space-y-2">
                    ...
                    <div className="bg-gray-700 p-4 rounded-lg border-l-4 border-red-500">
                      <h3 className="text-lg font-semibold text-gray-100 mb-2">❌ Late Refund Requests</h3>
                      <ul className="list-disc pl-6 space-y-2">
                ...
                <section>
                  ...
                  <div className="bg-gray-700 p-4 rounded-lg space-y-3">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        <h3 className="font-semibold text-gray-100">Contact Support Within 24 Hours</h3>
                        <p className="text-sm text-gray-400">Email <a href="mailto:info@enqir.in" className="text-blue-600 hover:underline font-semibold">info@enqir.in</a> with subject "Refund Request - [Transaction ID]"</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        <h3 className="font-semibold text-gray-100">Provide Required Information</h3>
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        <h3 className="font-semibold text-gray-100">Wait for Verification</h3>
                        <p className="text-sm text-gray-400">Our team will review your request within 2-3 business days and contact you via email</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        <h3 className="font-semibold text-gray-100">Refund Processing</h3>
                        <p className="text-sm text-gray-400">If approved, refund will be initiated within 5-7 business days</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        <h3 className="font-semibold text-gray-100">Receive Refund</h3>
                        <p className="text-sm text-gray-400">Refund credited to original payment method within 7-10 business days (depending on your bank)</p>
                      </div>
                    </div>
                  </div>
                </section>
                ...
                <section>
                  <h2 className="text-xl sm:text-2xl font-semibold text-white mb-2 sm:mb-3">5. Refund Timeline</h2>
                ...
                <section>
                  <h2 className="text-xl sm:text-2xl font-semibold text-white mb-2 sm:mb-3">6. Cancellation Policy</h2>
                  <div className="bg-gray-700 p-3 sm:p-4 rounded-lg border-l-4 border-yellow-500">
                    <p className="mb-2 sm:mb-3 leading-relaxed">
                ...
                <section>
                  <h2 className="text-xl sm:text-2xl font-semibold text-white mb-2 sm:mb-3">7. Payment Plan-Specific Terms</h2>
                  
                  <div className="space-y-2 sm:space-y-3">
                    <div className="border-l-4 border-purple-500 pl-3 sm:pl-4">
                      <h3 className="font-semibold text-gray-100 text-sm sm:text-base">Free Plan (₹0)</h3>
                      <p className="text-xs sm:text-sm text-gray-400 leading-relaxed">No payment, no refund applicable</p>
                    </div>

                    <div className="border-l-4 border-blue-500 pl-3 sm:pl-4">
                      <h3 className="font-semibold text-gray-100 text-sm sm:text-base">Basic Plan (₹99)</h3>
                      <p className="text-xs sm:text-sm text-gray-400 leading-relaxed">Unlocks 5 responses for one enquiry. No refund after viewing responses.</p>
                    </div>

                    <div className="border-l-4 border-green-500 pl-3 sm:pl-4">
                      <h3 className="font-semibold text-gray-100 text-sm sm:text-base">Standard Plan (₹199)</h3>
                      <p className="text-xs sm:text-sm text-gray-400 leading-relaxed">Unlocks 10 responses for one enquiry. No refund after viewing responses.</p>
                    </div>

                    <div className="border-l-4 border-yellow-500 pl-3 sm:pl-4">
                      <h3 className="font-semibold text-gray-100 text-sm sm:text-base">Premium Plan (₹499)</h3>
                      <p className="text-xs sm:text-sm text-gray-400 leading-relaxed">Unlocks unlimited responses for one enquiry. No refund after activation.</p>
                    </div>
                  </div>
                </section>

                <section>
                  <h2 className="text-xl sm:text-2xl font-semibold text-white mb-2 sm:mb-3">7.1 Return Shipping Costs (For Physical Products, if any)</h2>
                  <div className="bg-gray-700 p-3 sm:p-4 rounded-lg border-l-4 border-yellow-500">
                ...
                <section>
                  <h2 className="text-xl sm:text-2xl font-semibold text-white mb-2 sm:mb-3">8. Grievance Officer</h2>
                  <p className="mb-2 sm:mb-3 leading-relaxed">
                  ...
                  <div className="bg-gray-700 p-3 sm:p-4 rounded-lg border-l-4 border-green-500">
                    ...
                    <p className="text-xs sm:text-sm text-gray-400 mt-2"><strong>Response Time:</strong> Within 24-48 hours</p>
                  </div>
                </section>

                <section>
                  <h2 className="text-xl sm:text-2xl font-semibold text-white mb-2 sm:mb-3">9. Dispute Resolution</h2>
                  <p className="mb-2 sm:mb-3 leading-relaxed">
                ...
                <section>
                  <h2 className="text-xl sm:text-2xl font-semibold text-white mb-2 sm:mb-3">10. Contact Information</h2>
                  <div className="bg-gray-700 p-3 sm:p-4 rounded-lg">
                    ...
                    <ul className="list-disc pl-5 sm:pl-6 space-y-1 text-xs sm:text-sm text-gray-400 leading-relaxed">
                ...
                <section>
                  <h2 className="text-xl sm:text-2xl font-semibold text-white mb-2 sm:mb-3">11. Policy Updates</h2>
                ...
                <section className="border-t pt-4 sm:pt-6 mt-4 sm:mt-6 bg-gray-700 p-3 sm:p-4 rounded-lg">
                  <h3 className="text-base sm:text-lg font-semibold text-white mb-1.5 sm:mb-2">📌 Important Reminder</h3>
