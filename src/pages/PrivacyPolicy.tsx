    ...
    <Layout>
      <div className="container mx-auto px-2 sm:px-4 py-4 sm:py-8 max-w-4xl">
        <Card className="shadow-lg bg-gray-800 border-gray-700">
          <CardHeader className="bg-gradient-to-r from-blue-600 to-cyan-600 text-white p-4 sm:p-6 border-b border-gray-700">
          ...
          <CardContent className="p-4 sm:p-6 bg-gray-800">
            <ScrollArea className="h-[calc(100vh-8rem)] sm:h-[70vh] pr-2 sm:pr-4">
              <div className="space-y-4 sm:space-y-6 text-gray-200 text-sm sm:text-base">
                ...
                <section>
                  <h2 className="text-xl sm:text-2xl font-semibold text-white mb-2 sm:mb-3 flex items-center gap-2">
                ...
                <section>
                  ...
                  <h3 className="text-xl font-semibold text-gray-100 mb-2">2.1 Information You Provide Directly</h3>
                  ...
                  <h3 className="text-xl font-semibold text-gray-100 mb-2">2.2 Information Collected Automatically</h3>
                  <ul className="list-disc pl-6 space-y-2 mb-4">
                  ...
                  <h3 className="text-lg sm:text-xl font-semibold text-gray-100 mb-1.5 sm:mb-2">2.3 Information from Third Parties</h3>
                ...
                <section>
                  ...
                  <div className="bg-gray-700 p-4 rounded-lg mb-4">
                    <h3 className="text-lg font-semibold text-gray-100 mb-2">Core Platform Functions</h3>
                  ...
                  <h3 className="text-xl font-semibold text-gray-100 mb-2">Other Uses</h3>
                  <ul className="list-disc pl-6 space-y-2">
                ...
                <section>
                  <h2 className="text-xl sm:text-2xl font-semibold text-white mb-2 sm:mb-3">4. Information Sharing and Disclosure</h2>
                  
                  <h3 className="text-lg sm:text-xl font-semibold text-gray-100 mb-1.5 sm:mb-2">4.1 When We Share Your Information</h3>
                  ...
                  <div className="bg-gray-700 p-3 sm:p-4 rounded-lg border-l-4 border-blue-500 mb-3 sm:mb-4">
                    <h4 className="font-semibold text-gray-100 mb-1.5 sm:mb-2">Payment Gateway Data Sharing</h4>
                  ...
                  <h3 className="text-lg sm:text-xl font-semibold text-gray-100 mb-1.5 sm:mb-2">4.2 What We DON'T Share</h3>
                  <ul className="list-disc pl-5 sm:pl-6 space-y-1.5 sm:space-y-2 leading-relaxed">
                ...
                <section>
                  <h2 className="text-2xl font-semibold text-white mb-3">8. Cookies and Tracking Technologies</h2>
                ...
                <section>
                  <h2 className="text-2xl font-semibold text-white mb-3">11. International Data Transfers</h2>
                  <p className="mb-3">
                ...
                <section>
                  <h2 className="text-xl sm:text-2xl font-semibold text-white mb-2 sm:mb-3">12. Third-Party Services</h2>
                ...
                <section>
                  <h2 className="text-2xl font-semibold text-white mb-3">13. Changes to Privacy Policy</h2>
                  <p>
                ...
                <section>
                  <h2 className="text-xl sm:text-2xl font-semibold text-white mb-2 sm:mb-3">14. Contact Us</h2>
                  <div className="bg-gray-700 p-3 sm:p-4 rounded-lg">
                    ...
                    <p className="mt-2 text-xs sm:text-sm text-gray-400"><strong>Response Time:</strong> Within 24-48 hours</p>
                  </div>
                </section>

                <section>
                  <h2 className="text-2xl font-semibold text-white mb-3">15. Compliance</h2>
                  <p>
