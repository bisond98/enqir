        ...
        <Card className="shadow-2xl border-0 overflow-hidden rounded-2xl sm:rounded-3xl">
          <CardHeader className="bg-black p-2 sm:p-3 md:p-4">
            <div className="flex items-center gap-1.5 sm:gap-2">
              ...
              <div>
                <CardTitle className="text-base sm:text-lg md:text-xl font-bold text-white">Privacy Policy</CardTitle>
          ...
          <CardContent className="p-2 sm:p-3 md:p-4 bg-white">
            <ScrollArea className="h-[calc(100vh-10rem)] sm:h-[calc(100vh-12rem)] md:h-[70vh] pr-2 sm:pr-4">
              <div className="space-y-2 sm:space-y-3 md:space-y-4 text-gray-700 text-[10px] sm:text-xs md:text-sm leading-relaxed">
                ...
                <section>
                  <h2 className="text-sm sm:text-base md:text-lg font-semibold text-gray-900 mb-1.5 sm:mb-2 flex items-center gap-1.5">
                    <Eye className="w-3.5 h-3.5 sm:w-4 sm:h-4 md:w-5 md:h-5 text-blue-600" />
                    1. Introduction
                  </h2>
                ...
                <section>
                  <h2 className="text-sm sm:text-base md:text-lg font-semibold text-gray-900 mb-2 sm:mb-2.5 flex items-center gap-1.5">
                    <Database className="w-3.5 h-3.5 sm:w-4 sm:h-4 md:w-5 md:h-5 text-blue-600" />
                    2. Information We Collect
                  </h2>
                  
                  <h3 className="text-xs sm:text-sm md:text-base font-semibold text-gray-800 mb-1.5">2.1 Information You Provide Directly</h3>
                  <ul className="list-disc pl-4 sm:pl-5 space-y-1 sm:space-y-1.5 mb-2 sm:mb-3">
                  ...
                  <h3 className="text-xs sm:text-sm md:text-base font-semibold text-gray-800 mb-1.5">2.2 Information Collected Automatically</h3>
                  <ul className="list-disc pl-4 sm:pl-5 space-y-1 sm:space-y-1.5 mb-2 sm:mb-3">
                  ...
                  <h3 className="text-xs sm:text-sm md:text-base font-semibold text-gray-800 mb-1.5">2.3 Information from Third Parties</h3>
                ...
                <section>
                  <h2 className="text-sm sm:text-base md:text-lg font-semibold text-gray-900 mb-2 sm:mb-2.5 flex items-center gap-1.5">
                    <Lock className="w-3.5 h-3.5 sm:w-4 sm:h-4 md:w-5 md:h-5 text-blue-600" />
                    3. How We Use Your Information
                  </h2>
                  
                  <div className="bg-gray-50 p-2 sm:p-3 rounded-lg mb-2 sm:mb-3">
                    <h3 className="text-xs sm:text-sm font-semibold text-gray-800 mb-1.5">Core Platform Functions</h3>
                  ...
                  <div className="bg-gray-50 p-2 sm:p-3 rounded-lg mb-2 sm:mb-3">
                    <h3 className="text-xs sm:text-sm font-semibold text-gray-800 mb-1.5">AI-Powered Features</h3>
                    <ul className="list-disc pl-4 sm:pl-5 space-y-1 sm:space-y-1.5">
                  ...
                  <h3 className="text-xs sm:text-sm md:text-base font-semibold text-gray-800 mb-1.5">Other Uses</h3>
                  <ul className="list-disc pl-4 sm:pl-5 space-y-1 sm:space-y-1.5">
                ...
                <section>
                  <h2 className="text-sm sm:text-base md:text-lg font-semibold text-gray-900 mb-2">4. Information Sharing and Disclosure</h2>
                  
                  <h3 className="text-xs sm:text-sm md:text-base font-semibold text-gray-800 mb-1.5">4.1 When We Share Your Information</h3>
                  <p className="mb-1.5 sm:mb-2 leading-relaxed">
                    We may share your information with third parties in the following circumstances:
                  </p>
                  <ul className="list-disc pl-4 sm:pl-5 space-y-1 sm:space-y-1.5 mb-2 sm:mb-3 leading-relaxed">
                  ...
                  <div className="bg-gray-50 p-2 sm:p-3 rounded-lg border-l-4 border-blue-500 mb-2 sm:mb-3">
                    <h4 className="text-xs sm:text-sm font-semibold text-gray-800 mb-1.5">Payment Gateway Data Sharing</h4>
                    <p className="text-[10px] sm:text-xs text-gray-700 leading-relaxed mb-1.5">
                      When you make a payment, we share the following information with our payment gateway partners:
                    </p>
                    <ul className="list-disc pl-4 sm:pl-5 space-y-0.5 sm:space-y-1 text-[10px] sm:text-xs text-gray-700 leading-relaxed">
                    ...
                    <p className="mt-1.5 text-[10px] sm:text-xs text-gray-700 leading-relaxed">
                  ...
                  <h3 className="text-xs sm:text-sm md:text-base font-semibold text-gray-800 mb-1.5">4.2 What We DON'T Share</h3>
                  <ul className="list-disc pl-4 sm:pl-5 space-y-1 sm:space-y-1.5 leading-relaxed">
                ...
                <section>
                  <h2 className="text-sm sm:text-base md:text-lg font-semibold text-gray-900 mb-2 flex items-center gap-1.5">
                    <UserCheck className="w-3.5 h-3.5 sm:w-4 sm:h-4 md:w-5 md:h-5 text-blue-600" />
                ...
                <section>
                  ...
                  <div className="bg-gray-50 p-2 sm:p-3 rounded-lg">
                    <p className="mb-1.5 sm:mb-2 leading-relaxed">We implement industry-standard security measures to protect your data:</p>
                    <ul className="list-disc pl-4 sm:pl-5 space-y-1 sm:space-y-1.5 leading-relaxed">
                ...
                <section>
                  <h2 className="text-sm sm:text-base md:text-lg font-semibold text-gray-900 mb-2">7. Data Retention</h2>
                  <ul className="list-disc pl-4 sm:pl-5 space-y-1 sm:space-y-1.5">
                ...
                <section>
                  <h2 className="text-sm sm:text-base md:text-lg font-semibold text-gray-900 mb-2">8. Cookies and Tracking Technologies</h2>
                ...
                <section>
                  <h2 className="text-sm sm:text-base md:text-lg font-semibold text-gray-900 mb-2 flex items-center gap-1.5">
                    <Bell className="w-3.5 h-3.5 sm:w-4 sm:h-4 md:w-5 md:h-5 text-blue-600" />
                ...
                <section>
                  <h2 className="text-sm sm:text-base md:text-lg font-semibold text-gray-900 mb-2">10. Children's Privacy</h2>
                  <p>
                ...
                <section>
                  <h2 className="text-sm sm:text-base md:text-lg font-semibold text-gray-900 mb-2">11. International Data Transfers</h2>
                  <p className="mb-2">
                ...
                <section>
                  <h2 className="text-sm sm:text-base md:text-lg font-semibold text-gray-900 mb-2">12. Third-Party Services</h2>
                  <p className="mb-1.5 sm:mb-2 leading-relaxed">We integrate with third-party services that have their own privacy policies. By using our Platform, you agree to the terms and privacy policies of these third-party service providers:</p>
                ...
                <section>
                  <h2 className="text-sm sm:text-base md:text-lg font-semibold text-gray-900 mb-2">13. Changes to Privacy Policy</h2>
                  <p>
                ...
                <section>
                  <h2 className="text-sm sm:text-base md:text-lg font-semibold text-gray-900 mb-2">14. Contact Us</h2>
                  <div className="bg-gray-50 p-2 sm:p-3 rounded-lg">
                    <p className="mb-1.5 sm:mb-2 leading-relaxed">For privacy-related questions, concerns, or requests, contact us:</p>
                    ...
                    <p className="mb-2"><strong>Grievance Email:</strong> <a href="mailto:zebhere4@gmail.com" className="text-blue-600 hover:underline font-semibold">zebhere4@gmail.com</a></p>
                    <p className="mb-2"><strong>Support Email:</strong> <a href="mailto:zebhere4@gmail.com" className="text-blue-600 hover:underline font-semibold">zebhere4@gmail.com</a></p>
                    ...
                    <p className="mt-1.5 text-[10px] sm:text-xs text-gray-600"><strong>Response Time:</strong> Within 24-48 hours</p>
                  </div>
                </section>

                <section>
                  <h2 className="text-sm sm:text-base md:text-lg font-semibold text-gray-900 mb-2">15. Compliance</h2>
                  <p>
                    We comply with applicable data protection laws, including:
                  </p>
                  <ul className="list-disc pl-4 sm:pl-5 space-y-1 sm:space-y-1.5 mt-2">
                ...
                <section className="border-t pt-3 sm:pt-4 mt-3 sm:mt-4">
