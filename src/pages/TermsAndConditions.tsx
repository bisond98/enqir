      ...
      <div className="container mx-auto px-2 sm:px-4 py-2 sm:py-4 max-w-4xl">
        <Card className="shadow-2xl border-0 overflow-hidden rounded-2xl sm:rounded-3xl">
          <CardHeader className="bg-black p-2 sm:p-3 md:p-4">
            <CardTitle className="text-base sm:text-lg md:text-xl font-bold text-white">Terms and Conditions</CardTitle>
          ...
          <CardContent className="p-2 sm:p-3 md:p-4 bg-white">
            <ScrollArea className="h-[calc(100vh-10rem)] sm:h-[calc(100vh-12rem)] md:h-[70vh] pr-2 sm:pr-4">
              <div className="space-y-2 sm:space-y-3 md:space-y-4 text-gray-700 text-[10px] sm:text-xs md:text-sm leading-relaxed">
                ...
                <section>
                  <h2 className="text-sm sm:text-base md:text-lg font-semibold text-gray-900 mb-1.5 sm:mb-2">1. Acceptance of Terms</h2>
                ...
                <section>
                  <h2 className="text-sm sm:text-base md:text-lg font-semibold text-gray-900 mb-1.5 sm:mb-2">2. Service Description</h2>
                  <p className="mb-1.5 sm:mb-2 leading-relaxed">
                  ...
                  <p className="mt-1.5 sm:mt-2 text-[10px] sm:text-xs text-gray-600 italic">
                ...
                <section>
                  <h2 className="text-sm sm:text-base md:text-lg font-semibold text-gray-900 mb-1.5 sm:mb-2">3. User Accounts</h2>
                  <h3 className="text-xs sm:text-sm md:text-base font-semibold text-gray-800 mb-1.5">3.1 Registration and Eligibility</h3>
                  ...
                  <h3 className="text-xs sm:text-sm md:text-base font-semibold text-gray-800 mb-1.5">3.2 Account Responsibilities</h3>
                  <ul className="list-disc pl-4 sm:pl-5 space-y-1 sm:space-y-1.5 leading-relaxed">
                ...
                <section>
                  <h2 className="text-sm sm:text-base md:text-lg font-semibold text-gray-900 mb-1.5 sm:mb-2">4. Payment Terms</h2>
                  
                  <h3 className="text-xs sm:text-sm md:text-base font-semibold text-gray-800 mb-1.5">4.1 Payment Plans</h3>
                  <div className="bg-gray-50 p-2 sm:p-3 rounded-lg mb-2">
                    <ul className="space-y-1 sm:space-y-1.5 text-[10px] sm:text-xs md:text-sm">
                  ...
                  <h3 className="text-xs sm:text-sm md:text-base font-semibold text-gray-800 mb-1.5">4.2 Payment Processing</h3>
                  <ul className="list-disc pl-4 sm:pl-5 space-y-1 sm:space-y-1.5 mb-2 leading-relaxed">
                  ...
                  <h3 className="text-xs sm:text-sm md:text-base font-semibold text-gray-800 mb-1.5">4.3 Billing</h3>
                  <ul className="list-disc pl-4 sm:pl-5 space-y-1 sm:space-y-1.5 leading-relaxed">
                ...
                <section>
                  <h2 className="text-sm sm:text-base md:text-lg font-semibold text-gray-900 mb-1.5 sm:mb-2">5. Refund and Cancellation Policy</h2>
                  <p className="mb-1.5 sm:mb-2 leading-relaxed">
                  ...
                  <h3 className="text-xs sm:text-sm md:text-base font-semibold text-gray-800 mb-1.5">5.1 Refund Eligibility</h3>
                  <ul className="list-disc pl-4 sm:pl-5 space-y-1 sm:space-y-1.5 mb-2 leading-relaxed">
                  ...
                  <h3 className="text-xs sm:text-sm md:text-base font-semibold text-gray-800 mb-1.5">5.2 Non-Refundable Scenarios</h3>
                  <ul className="list-disc pl-4 sm:pl-5 space-y-1 sm:space-y-1.5 mb-2 leading-relaxed">
                  ...
                  <h3 className="text-xs sm:text-sm md:text-base font-semibold text-gray-800 mb-1.5">5.3 Refund Process</h3>
                  <ul className="list-disc pl-4 sm:pl-5 space-y-1 sm:space-y-1.5 leading-relaxed">
                ...
                <section>
                  <h2 className="text-sm sm:text-base md:text-lg font-semibold text-gray-900 mb-1.5 sm:mb-2">6. User Conduct and Prohibited Activities</h2>
                  <p className="mb-1.5 sm:mb-2 leading-relaxed">You agree NOT to:</p>
                  <ul className="list-disc pl-4 sm:pl-5 space-y-1 sm:space-y-1.5 leading-relaxed">
                ...
                <section>
                  <h2 className="text-sm sm:text-base md:text-lg font-semibold text-gray-900 mb-1.5 sm:mb-2">7. AI and Content Moderation</h2>
                  <ul className="list-disc pl-4 sm:pl-5 space-y-1 sm:space-y-1.5 leading-relaxed">
                ...
                <section>
                  <h2 className="text-sm sm:text-base md:text-lg font-semibold text-gray-900 mb-1.5 sm:mb-2">8. Intellectual Property</h2>
                  <p className="mb-1.5 sm:mb-2 leading-relaxed">
                ...
                <section>
                  <h2 className="text-sm sm:text-base md:text-lg font-semibold text-gray-900 mb-1.5 sm:mb-2">9. Limitation of Liability</h2>
                  <ul className="list-disc pl-4 sm:pl-5 space-y-1 sm:space-y-1.5 mb-2 leading-relaxed">
                ...
                <section>
                  <h2 className="text-sm sm:text-base md:text-lg font-semibold text-gray-900 mb-1.5 sm:mb-2">10. Disclaimer of Warranties</h2>
                  <p className="mb-1.5 sm:mb-2 leading-relaxed font-semibold">
                ...
                <section>
                  <h2 className="text-sm sm:text-base md:text-lg font-semibold text-gray-900 mb-1.5 sm:mb-2">11. Data Privacy</h2>
                  <p className="leading-relaxed">
                ...
                <section>
                  <h2 className="text-sm sm:text-base md:text-lg font-semibold text-gray-900 mb-1.5 sm:mb-2">12. Termination</h2>
                  <ul className="list-disc pl-4 sm:pl-5 space-y-1 sm:space-y-1.5 leading-relaxed">
                ...
                <section>
                  <h2 className="text-sm sm:text-base md:text-lg font-semibold text-gray-900 mb-1.5 sm:mb-2">13. Third-Party Services</h2>
                  <p className="mb-1.5 sm:mb-2 leading-relaxed">
                ...
                <section>
                  <h2 className="text-sm sm:text-base md:text-lg font-semibold text-gray-900 mb-1.5 sm:mb-2">14. Governing Law and Dispute Resolution</h2>
                  <ul className="list-disc pl-4 sm:pl-5 space-y-1 sm:space-y-1.5 leading-relaxed">
                ...
                <section>
                  <h2 className="text-sm sm:text-base md:text-lg font-semibold text-gray-900 mb-1.5 sm:mb-2">15. Our Responsibilities</h2>
                  <p className="mb-1.5 sm:mb-2 leading-relaxed">
                ...
                <section>
                  <h2 className="text-sm sm:text-base md:text-lg font-semibold text-gray-900 mb-1.5 sm:mb-2">16. Grievance Officer</h2>
                  <p className="mb-1.5 sm:mb-2 leading-relaxed">
                  ...
                  <div className="bg-gray-50 p-2 sm:p-3 rounded-lg border-l-4 border-purple-500">
                    <p className="mb-2"><strong>Name:</strong> zeb</p>
                    <p className="mb-2"><strong>Email:</strong> <a href="mailto:zebhere4@gmail.com" className="text-purple-600 hover:underline font-semibold">zebhere4@gmail.com</a></p>
                    <p className="text-[10px] sm:text-xs text-gray-600 mt-1.5"><strong>Response Time:</strong> We will respond to your grievance within 24-48 hours</p>
                  </div>
                ...
                <section>
                  <h2 className="text-sm sm:text-base md:text-lg font-semibold text-gray-900 mb-1.5 sm:mb-2">17. Modifications to Terms</h2>
                  <p className="leading-relaxed">
                ...
                <section>
                  <h2 className="text-sm sm:text-base md:text-lg font-semibold text-gray-900 mb-1.5 sm:mb-2">18. Contact Information</h2>
                  <div className="bg-gray-50 p-2 sm:p-3 rounded-lg">
                    ...
                    <p className="mb-2"><strong>Owner Email:</strong> <a href="mailto:zebhere4@gmail.com" className="text-purple-600 hover:underline font-semibold">zebhere4@gmail.com</a></p>
