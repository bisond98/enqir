        ...
        <div className="flex flex-col sm:flex-row gap-2 sm:gap-4 items-center justify-center mb-6 sm:mb-16 animate-slide-up px-1 sm:px-0" style={{ animationDelay: '0.4s' }}>
          ...
          <section className="py-4 sm:py-16 relative w-full" style={{ 
            ...
            >
                      ...
                      <div className="px-2.5 pt-2.5 sm:px-3 sm:pt-3 sm:pb-0 flex-1 flex flex-col overflow-hidden min-h-0" style={{ paddingBottom: windowWidth < 640 ? '1.25rem' : undefined }}>
                      ...
                      <div className="flex flex-col w-full gap-3 sm:gap-1.5 flex-1">
                        ...
                        <div className="block sm:hidden w-full mt-auto" style={{ marginTop: windowWidth < 640 ? '-1rem' : undefined }}>
