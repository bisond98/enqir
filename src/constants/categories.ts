...
export const CATEGORY_SEARCH_SYNONYMS: Record<string, string[]> = {
  ...
  car: ['vehicle', 'automobile', 'four wheeler', 'four-wheeler', '4 wheeler', '4-wheeler', 'car', 'cars'],
  automobile: ['vehicle', 'car', 'cars', 'four wheeler', 'four-wheeler', '4 wheeler', '4-wheeler'],
  vehicles: ['vehicle', 'vehicles', 'car', 'cars', 'four wheeler', 'four-wheeler', '4 wheeler', '4-wheeler', 'bike', 'motorcycle', 'two wheeler'],
  bike: ['motorcycle', 'motorcycles', 'motorbike', 'motorbikes', 'bike', 'bikes', 'scooter', 'scooters', 'two-wheeler', 'two wheeler', '2 wheeler', 'scooty'],
